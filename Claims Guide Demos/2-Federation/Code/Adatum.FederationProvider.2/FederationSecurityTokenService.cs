...
namespace Adatum.FederationProvider
{
    ...
    {
        private const string LitwareIssuer = "https://localhost/Litware.SimulatedIssuer.2/";
        private const string AdatumIssuer = "https://localhost/Adatum.SimulatedIssuer.2/";
