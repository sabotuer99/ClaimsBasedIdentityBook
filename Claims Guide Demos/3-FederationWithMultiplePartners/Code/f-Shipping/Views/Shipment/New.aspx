...
<%
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            <%=this.Html.Tooltip(Resources.TooltipText.NameClaimHint)%>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            ...
                            <%=this.Html.Tooltip(Resources.TooltipText.AddressClaimHint)%>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <%=this.Html.Tooltip(Resources.TooltipText.ProfileProviderHint)%>
                        </td>
                    </tr>
                    <tr>
                        <td>
    ...
    {%>
    User <b><%=this.User.Identity.Name%></b> could not be found in the database, please contact the sales representative to add a new subscription for this user.
<%
    }%>
</asp:Content>
