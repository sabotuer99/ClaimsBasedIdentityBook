            ...
            <span class="explanationsection">
                <div id="yourIssuerTab" class="issuerOptionTab">
                    <div class="sampleform">
                        <%this.Html.BeginForm("CreateTenantFromFedMetadaFile", "Enrollment", FormMethod.Post, new { enctype = "multipart/form-data" }); %>
                        <table>
                            <tbody>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="file" name="logoFile" id="logoFile" size="50" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="file" name="fedMetadataFile" id="fedMetadataFile" size="50" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <div id="samplefile">
                                            <%=this.Html.ActionLink("view sample file", "FederationMetadataSample", "Home")%></div>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
