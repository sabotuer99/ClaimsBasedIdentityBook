...
namespace ACS.Setup
{
    ...
    internal class Program
    {
        ...
        private const string LitwareIdentityProvider = "Litware.8";
        private const string LitwareFederationMetaDataLocation = @"..\..\..\Litware.SimulatedIssuer.8\FederationMetadata\2007-06\FederationMetadata.xml";
        private const string AOrderRelyingParty = "aOrderService.8";
        private const string AOrderRealmAddress = "https://localhost/a-Order.OrderTracking.Services.8";
        private const string TokenKey = "lJFL02dwy9n3rCe2YEToblDFHdZmbecmFK1QB88ax7U=";
        ...
        private static void CreateAOrderRelyingPartyWithRules(ServiceManagementWrapper acsWrapper)
        {
            ...
            acsWrapper.AddRelyingPartyWithSymmetricKey(AOrderRelyingParty, AOrderRealmAddress, string.Empty, key, TokenType.SWT, 30, ruleGroup, ips);
            Console.WriteLine("done");
