<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="Default.aspx.cs" Inherits="PassiveFlowIPSTS1._Default" ValidateRequest="false" %>
...
<body>
    ...
    <div>
        At the Identity Provider STS-1. Federation Provider STS has redirected the user to authenticate here.
    </div>
    </form>
</body>
</html>
