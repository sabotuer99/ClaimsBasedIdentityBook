...
namespace Adatum.FederationProvider
{
    ...
    {
        public readonly string AcsIssuerIdentifier = WebConfigurationManager.AppSettings["AcsIssuer"];
        ...
        private void HandleSignInRequest()
        {
            ...
            if (TrustedIssuers.Instance.IsValidRealm(homeRealm))
            {
                var federatedIssuer = TrustedIssuers.Instance[homeRealm];
